...
class MSRPTestClientFactory(ClientFactory):
    ...
    def _get_path(self, msrpdata):
        ...
        reactor.callLater(3, self._send_msg1)
    ...
    def _send_msg1(self):
        ...
        msrpdata.add_header(ContentTypeHeader("text/plain"))
        data = msrpdata.encode_start() + "Is there anybody out there...?" + msrpdata.encode_end("$")
        print "SENDING:\n\n%s" % data
