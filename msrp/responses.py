...
class ResponseException(ResponseExceptionBase):
    def __init__(self, code, request_data, comment=None, headers=None):
...
class ResponseUnintelligible(ResponseException):
    ...
    def __init__(self, request_data, comment=None, headers=None):
        if comment:
...
class ResponseUnknownMediaType(ResponseException):
    ...
    def __init__(self, request_data, content_type=None, headers=None):
...
class ResponseOutOfBounds(ResponseException):
    ...
    def __init__(self, request_data, parameter=None, headers=None):
        if parameter:
